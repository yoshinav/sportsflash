...
public class MLBPlayerHandler extends DefaultHandler {
    ...
    private MLBPlayerRecord mlbPlayerRecord;

    public MLBPlayerHandler() {
        mlbPlayerRecord = new MLBPlayerRecord();
    }
    ...
    public MLBPlayerRecord getWeatherRecord() {
        return mlbPlayerRecord;
    }

    public void setWeatherRecord(MLBPlayerRecord mlbPlayerRecord) {
