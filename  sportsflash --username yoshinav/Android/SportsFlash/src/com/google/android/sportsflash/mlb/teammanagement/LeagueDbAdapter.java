...
/**
 * LeagueDBAdpater:  League DB Adapter class
 * 
 * @author Navdeep Alam, with credit to Google
...
public class LeagueDbAdapter {
     ...
     */
    public LeagueDbAdapter(Context ctx) {
        this.mCtx = ctx;
    }
     ...
     */
    public LeagueDbAdapter open() throws SQLException {
        try {
